...
export async function assertNoSymlinkAncestors(candidate, label, { allowMissing = true } = {}) {
	const absolute = assertAbsolute(candidate, label);
	return assertNoSymlinkComponents(path.dirname(absolute), label, { allowMissing });
}
